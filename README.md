...
[![Version](https://img.shields.io/badge/version-2.12.0-8b5cf6?style=for-the-badge)](CHANGELOG.md)
[![Tests](https://img.shields.io/badge/tests-629%2F629%20passing-06b6d4?style=for-the-badge&logo=checkmarx)](tests/run_tests.php)
...
| 服务提供者 | 数据库事务 / Savepoint | 组件化视图 | 会话 Cookie 安全 | 629+ 测试断言 |
...
框架通过 629+ 测试断言保障核心组件稳定性：

```bash
php bin/console test   # 629/629 测试通过
```
